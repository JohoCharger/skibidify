export default function Navbar() {
    return (
        <nav className="navbar bg-body py-3 navbar-expand-md border-bottom border-white">
            <div className="container"><a className="navbar-brand d-flex align-items-center" href="#"><span
                ...
                </svg></span><span className="text-white">Skibidi<span className="text-danger">Fy</span></span></a>
                ...
                <div className="d-none d-md-block">
                    <a className="btn btn-light me-2" href="/login" type="button">Sign in</a>
                    <a className="btn btn-light" role="button" href="#">Account</a></div>
            </div>
        </nav>
    )
}